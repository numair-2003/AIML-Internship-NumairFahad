...
- **Identity**: The web app is anonymous and sends a browser-local identity header; the backend also accepts Clerk JWTs for existing/mobile clients.
...
- Vite config uses `tailwindcss({ optimize: false })`.
